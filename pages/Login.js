        ...
        <View style={[t.bgBlue600, t.relative, t.hFull, t.wFull]}>
            <View style={[t.itemsCenter, t.mT16]}>
                ...
                <View style={[t.flex, t.flexRow]}>
                    <TouchableOpacity style={[t.mT8, t.border, t.borderGreen800, t.bgGreen800, t.p2]} onPress={ () => this.props.history.push("home")}>
                        <Text style={[t.fontBold, t.textWhite]}>INGRESAR</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[t.mT8, t.mL8, t.border, t.borderGray800, t.bgGray800, t.p2]} onPress={ () => this.props.history.push("registration")}>
